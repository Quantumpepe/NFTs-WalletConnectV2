import{n as p,m as u,R as f,M as g,x as a}from"./index-MECrIZa4.js";import{n as b,r as m,c as w}from"./index-BO64ANK_.js";import{T as l}from"./index-Ds7NzINf.js";const C={interpolate(r,e,t){if(r.length!==2||e.length!==2)throw new Error("inputRange and outputRange must be an array of length 2");const n=r[0]||0,i=r[1]||0,o=e[0]||0,s=e[1]||0;return t<n?o:t>i?s:(s-o)/(i-n)*(t-n)+o}},M=p`
  :host {
    width: 100%;
    display: block;
  }
